...
{
    public sealed class CrusaderStrike : CardModel
    {
        protected override List<DynamicVar> CanonicalVars => [new DamageVar(4m, ValueProp.Move)];
        int GainHolyPowerNumber = 1;


        public CrusaderStrike() :base(1,CardType.Attack,CardRarity.Common,TargetType.AnyEnemy,true)
        { }
